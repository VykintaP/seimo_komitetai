...
def get_initial_data() -> list[dict]:
    ...
    print(df.head())  # Verify the data structure
...
def serve_layout() -> html.Div:
    ...
    return html.Div(className="main-container", children=[
        ...
        html.Div([
            ...
            html.Div([
                dcc.Link("Daugiau apie projektą", href="/info", className="about-link")
            ], className="about-container")
        ], className="dashboard-header"),

        html.Div(className="active-filters-bar", children=[
            html.Div(id="active-filters", className="active-filters")
        ]),

        # Datos pasirinkimas virš grafiko
        html.Div(className="filter-controls top-filters", children=[
            html.Div(children=[
                dcc.DatePickerRange(
            ...
            #     className="filter-clear-button",  # pasirinktina – galima stiliui
            #     n_clicks=0
            # )
